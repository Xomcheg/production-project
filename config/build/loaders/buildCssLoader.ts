            ...
            { // этот лоадер необходим что бы работать с модулями
                ...
                options: {
                    modules: {
                        ...
                        localIdentName: isDev ? '[path][name]__[local]--[hash:base64:5]' : '[hash:base64:8]', // эта настройка необходима что бы контролировать формирование названия класса, так как в dom названия отображаются в виде хэшей
